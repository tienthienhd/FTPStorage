...
/**
 * Transfer a piece of file Must setPieceIndex before setFile;
 *
 * @author HP Zbook 15
 *
 */
public class Piece implements Runnable {
    ...
    public void setRaf() {
        //System.out.println("Debug 130 Piece: " + pieceIndex);
        try {
            if (isSend) {
                this.raf = new RandomAccessFile(file, "rw");
                this.raf.seek(startOffset + offset);
            } else {
                //System.out.println("Debug 136 Piece recv: " + pieceIndex);
